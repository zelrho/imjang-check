...
// ── 단지 프리셋 (data/policy.js 매물리스트 2026-08-02 기준 복사) ──
// 새 매물 추가할 때 기본정보 자동 입력용. 시세는 '시세'이지 호가가 아님 — 현장 호가는 직접 입력.
const PRESETS = [
  { 단지:"수원한일타운", 구:"수원시 장안구", 동:"조원동", 연식:1999, 세대수:5282,
    평형: [ {평:24, 매매:46000, 전세:30000}, {평:33, 매매:57000, 전세:38000} ] },
  { 단지:"영통포레파크원", 구:"수원시 영통구", 동:"영통동", 연식:1997, 세대수:3129,
    평형: [ {평:24, 매매:51000, 전세:33000} ] },
  { 단지:"인계 래미안 노블클래스 1단지", 구:"수원시 팔달구", 동:"인계동", 연식:2009, 세대수:892,
    평형: [ {평:25, 매매:64000, 전세:39000}, {평:34, 매매:72000, 전세:51000} ] },
  { 단지:"매탄위브 하늘채", 구:"수원시 영통구", 동:"매탄동", 연식:2008, 세대수:3391,
    평형: [ {평:24, 매매:64000, 전세:43000}, {평:33, 매매:79000, 전세:56000} ] },
  { 단지:"화서역 푸르지오 더 에듀포레", 구:"수원시 장안구", 동:"천천동", 연식:2009, 세대수:2571,
    평형: [ {평:25, 매매:67000, 전세:38000}, {평:33, 매매:80000, 전세:47000} ] },
  { 단지:"북수원 SK뷰 (수원SK스카이뷰)", 구:"수원시 장안구", 동:"정자동", 연식:2013, 세대수:3498,
    평형: [ {평:25, 매매:67000, 전세:44000}, {평:34, 매매:88000, 전세:54000} ] },
  { 단지:"수원역 푸르지오자이", 구:"수원시 팔달구", 동:"고등동", 연식:2021, 세대수:4086,
    평형: [ {평:24, 매매:72000, 전세:41000}, {평:34, 매매:87000, 전세:54000} ] },
];
const PRESET_기준일 = "2026-08-02";
